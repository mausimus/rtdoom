...
namespace rtdoom
{
	...
	void MapRenderer::RenderFrame(FrameBuffer& frameBuffer)
	{
		...
		// player view cone
		int clx, cly, crx, cry;
		MapToScreenCoords(m_gameState.m_player.x + 100.0f * cos(m_gameState.m_player.a - PI4), m_gameState.m_player.y + 100.0f * sin(m_gameState.m_player.a - PI4), clx, cly, frameBuffer);
		MapToScreenCoords(m_gameState.m_player.x + 100.0f * cos(m_gameState.m_player.a + PI4), m_gameState.m_player.y + 100.0f * sin(m_gameState.m_player.a + PI4), crx, cry, frameBuffer);
