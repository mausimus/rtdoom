...
const char* s_fragmentShaderSource = "#version 330 core\n"
                                   ...
                                   "in float TexNo;\n"
                                   "in float Light;\n"
                                   "uniform sampler2DArray _textures[16];\n"
                                   "void main()\n"
                                   "{\n"
                                   "       int tn = int(TexNo + 0.05);\n"
                                   "       FragColor = vec4(0, 0, 0, 0);\n"
                                   "       FragColor = tn == 0 ? texture(_textures[0], TexCoord) : FragColor;\n"
                                   "       FragColor = tn == 1 ? texture(_textures[1], TexCoord) : FragColor;\n"
                                   "       FragColor = tn == 2 ? texture(_textures[2], TexCoord) : FragColor;\n"
                                   "       FragColor = tn == 3 ? texture(_textures[3], TexCoord) : FragColor;\n"
                                   "       FragColor = tn == 4 ? texture(_textures[4], TexCoord) : FragColor;\n"
                                   "       FragColor = tn == 5 ? texture(_textures[5], TexCoord) : FragColor;\n"
                                   "       FragColor = tn == 6 ? texture(_textures[6], TexCoord) : FragColor;\n"
                                   "       FragColor = tn == 7 ? texture(_textures[7], TexCoord) : FragColor;\n"
                                   "       FragColor = tn == 8 ? texture(_textures[8], TexCoord) : FragColor;\n"
                                   "       FragColor = tn == 9 ? texture(_textures[9], TexCoord) : FragColor;\n"
                                   "       FragColor = tn == 10 ? texture(_textures[10], TexCoord) : FragColor;\n"
                                   "       FragColor = tn == 11 ? texture(_textures[11], TexCoord) : FragColor;\n"
                                   "       FragColor = tn == 12 ? texture(_textures[12], TexCoord) : FragColor;\n"
                                   "       FragColor = tn == 13 ? texture(_textures[13], TexCoord) : FragColor;\n"
                                   "       FragColor = tn == 14 ? texture(_textures[14], TexCoord) : FragColor;\n"
                                   "       FragColor = tn == 15 ? texture(_textures[15], TexCoord) : FragColor;\n"
